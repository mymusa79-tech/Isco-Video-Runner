...
def audit_tone_and_naturalness_with_mistral(
    ...
    The Engine remains authoritative for the prompt, semantic rules, fail-closed
    normalization, Approval Shopping behavior, and diagnostics. Clean V2 changes
    only the provider route for this scoped call.
    """
