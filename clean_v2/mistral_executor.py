...
planning, narrative_identity, script, visual_query_recovery, and text_audit.  A future independent Gold judge must use a
...
def _safe_invalid_json_diagnostic(
    raw_content: str, exc: json.JSONDecodeError
) -> dict[str, Any]:
