...
non-breaking hyphen, and Run #142 emitted quoted stock-search terms such as 'if-then'.
...
def normalize_clean_v2_stock_query(value: str) -> str:
    ...
    2. Convert commas to spaces, U+2011 to ASCII hyphen, and remove single/double quote
       presentation marks before stock search.
