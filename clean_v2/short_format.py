...
def short_prompt_context(brief: Mapping[str, Any]) -> str:
    ...
    return (
        ...
        "STRICTER SAFEGUARD: do not use any configured action word or any inflection/derivative of it anywhere in s3 except inside the single designated action sentence, even in a noun, past-tense, or descriptive role. "
