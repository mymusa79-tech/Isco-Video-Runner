...
## Closure 5 — Run51–203 cumulative regression / stale-stage evidence
...
Every Run from 51 through 203 belongs to exactly one audit cohort in `scripts/production_family_closure.json`; known repeated failure families are mapped separately to executable contracts and required phases. The latest audited twenty-run series (184–203) also has an exact incident ledger: each Run records Short/Long format, the real failure phase, a stable failure signature, and one or more reciprocal executable families. This corrects the former broad Run193–201/P3 classification: Runs 193–195 and 197 are Planning/P1, Runs 196 and 198 are Voice/P2, Runs 199–201 are Visual/P3, Run202 is entrypoint/P0, and Run203 is Long ingress/P0.
