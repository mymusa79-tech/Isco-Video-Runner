...
class GoldQCPendingTelegramClosureTests(unittest.TestCase):
    """Run #230 evidence folded into the existing Gold/control-plane family.

    The filename intentionally stays generic: the production Stage Ladder's named-run
    guard is a historical incident ledger, not a place to fabricate unobserved Runs
    218-229 merely because this regression was added after Run #230.
    """
