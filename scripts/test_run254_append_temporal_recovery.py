...
class Run254AppendTemporalRecoveryTests(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def _contract(self):
        ...
        return stage_contract.bind_request_contract(spec, "run254 exact append prompt")
    ...
    def test_append_repeated_temporal_failure_waits_once_then_becomes_no_wire(self) -> None:
        ...
        try:
            with patch.object(recovery.time, "sleep") as sleep:
                ...
                # The same exact request/model is already recovery-spent. Re-entering
                # it must fail over immediately instead of sleeping again.
