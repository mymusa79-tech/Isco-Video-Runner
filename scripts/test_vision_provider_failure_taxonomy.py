...
class VisionProviderFailureTaxonomyTests(unittest.TestCase):
    def test_exact_gemini_json_parser_failures_are_retryable_schema_failures(self) -> None:
        errors = (
    ...
    def test_unrelated_value_error_stays_fail_loud(self) -> None:
        exc = ValueError("internal programmer invariant failed")
