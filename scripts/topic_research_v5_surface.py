...
def _search_text() -> str:
    return (
        "🔎 بحث جديد\n\n"
        "سأعرض حتى 3 أفكار اجتازت الجودة، مع سبب واضح لكل فكرة.\n"
        "إذا لم توجد أفكار جيدة فلن أملأ القائمة بخيارات ضعيفة.\n\n"
        "البحث لا يبدأ الإنتاج."
    )
...
def _research_started_text(kind: str) -> str:
    ...
    return (
        f"🔎 بدأ بحث {label}\n\n"
        "أبحث الآن عن حتى 3 أفكار جيدة ومختلفة.\n"
        "سأعرض لك فقط ما يستحق الاختيار، مع زر للتفاصيل.\n\n"
        "البحث لا يبدأ الإنتاج."
    )
