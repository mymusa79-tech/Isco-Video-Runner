...
def materialize_brief(state: dict[str, Any], request_id: str, request_sha256: str, fmt: str, output: Path) -> dict[str, Any]:
    ...
    brief = {
        ...
        "editorial_intent": (
            "«خارج النص»: حديث عربي فصيح طبيعي لراوية أنثوية محايدة، بسيط في لغته وعميق في فكرته، "
            "يبدو كحديث شخص مع مستمع واحد لا كمقال مجهز، ويتقدم دون حشو أو تجارب شخصية مختلقة، "
