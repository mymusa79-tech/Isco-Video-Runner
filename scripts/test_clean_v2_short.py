...
class ShortContractTests(unittest.TestCase):
    ...
    def test_mistral_only_gets_explicit_short_contract_preflight(self) -> None:
        ...
        self.assertIn("complete grammatical boundary between words 16-18", seen["mistral"])
        self.assertIn("move the remaining detail into the next sentence", seen["mistral"])
