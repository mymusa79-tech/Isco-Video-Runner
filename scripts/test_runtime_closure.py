...
class RuntimeClosureTests(unittest.TestCase):
    ...
    def test_runtime_closure_installs_audio_binding_before_mastering_and_final_gate_last(self) -> None:
        calls=[]
        ...
        recovery.assert_called_once_with(); media_trust.assert_called_once_with(); semantic_binding.assert_called_once_with()
        audio.assert_called_once_with(); sfx.assert_called_once_with(); m8.assert_called_once_with(); m9.assert_called_once_with()
        m10.assert_called_once_with(); cta.assert_called_once_with(); music.assert_called_once_with(); bundle.assert_called_once_with()
